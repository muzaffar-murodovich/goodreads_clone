...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create(username="admin", first_name="Muzaffar")
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['user']['first_name'], "Muzaffar")
    ...
    def test_delete_review(self):
        ...
        response = self.client.delete(reverse('review-detail', kwargs={'id': br.id}))
    ...
    def test_patch_review(self):
        ...
        response = self.client.patch(reverse('review-detail', kwargs={'id': br.id}), data={'stars_given': 4})
        br.refresh_from_db()
    ...
    def test_put_review(self):
        ...
        response = self.client.put(
            reverse('review-detail', kwargs={'id': br.id}),
